...
{
	printf("workinnnnngggggggggggggggggggggggg");
...
{
	srand(time(0));
	ros::init(agrc,agrv,"pathFinder");
	ros::NodeHandle n;
	ros::Publisher pub =n.advertise<std_msgs::Int64MultiArray>("array",100);
